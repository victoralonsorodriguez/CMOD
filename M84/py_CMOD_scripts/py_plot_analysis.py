...
if __name__ == '__main__':
    ...
    galaxy_name = (cwd_galaxy.split('/')[-1]).split('_')[0]
    ...
    # Plot all available filters
        ...
        if analysis_programme == 'Galfit':
            # Magnitudes to plot
            mag_pairs_plot = [('Ind','Eff_rad_kpc'),('Mag','Mag'),('Ax_rat','Pos_ang'),('X_cent','Y_cent')]
        elif analysis_programme == 'Imfit':
            mag_pairs_plot = [('Ind','Eff_rad_kpc'),('I_e','I_e'),('Ax_rat','Pos_ang'),('X_cent','Y_cent')]
