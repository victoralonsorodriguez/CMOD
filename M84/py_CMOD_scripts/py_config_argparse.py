'''
This files obtain the argumens parsed as a flags
'''
...
from py_config_load import load_configuration
...
def argparse_values(phase):
    ...
    parser.add_argument('-pmc','--plot_max_columns', type=int, nargs='?', const=8, default=8,
