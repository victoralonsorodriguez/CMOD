...
def analisys():
    ...
    for datacube_pos,datacube_name in enumerate(datacube_name_list):
        ...
        for frame_pos in range(frame_range):
            ...
            output_file_path = f'{analysis_folder_name}/{output_file_name}'
                    ...
                    if analysis_programme == 'Galfit':
                        ...
                        create_script(file=script_file,
                            ...
                            create_conf_imfit(file=script_file,
                                    ...
                                    pa_ser = [pos_ang,0,180],
                                    ell_ser= [ell,0.05,0.95],
                                    n=[ser_index,0.6,6],
                                    r_e=[eff_rad,0,200],
                                    I_e=[I_e,1,
                                        round_number(I_e_bul_in+50,3)])
...
if __name__ == '__main__':
    ...
    try:
        analisys()
        print(f'The anlysis with {analysis_programme} has finished\n')
        
    except Exception as e:
        print(f'Error in the analysis module:\n{e}')
